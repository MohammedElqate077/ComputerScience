...
int main() {
 ...
 Vect1.add(19.99);
 Vect1.add('A');
 Vect1.set(3,str4); // index must be < sizeVectorL ; like strlen();
 Vect1.print();
 

 //Vect1.add(Vect2);

  cout << Vect1.get(3).get() << endl; 
  cout << Vect1.get(9).get() << endl; // will return null this is empty String;
  //if you want inform user use 2 line below
  /*if( Vect1.get(9).get() == NULL)  
     cout << "you get empty String" << endl;*/
  cout << str1.get() << endl;
  cout << str4.get() << endl;
  ...
  //cout << Vect1.remove(1).get() << endl;
  printf("\n%s\n",Vect1.remove(1).get());cout << " "  << endl;
  printf("%d",Vect1.getIndex(str4));cout << " " << endl;
  printf("%d",Vect1.getIndex(str1));cout << " " << endl;
  //cout << Vect1.getIndex(str1) << endl;
  Vect1.print();
  //cout << Vect1.size() << endl;
  printf("%d",Vect1.size());cout << endl;
  /* 
  // char bbb[] = "1234567890";
