...
<table border='1' align="center" width="60%">
    ...
    foreach ($liste as $e) {
        ...
        echo "
            <tr>
               <td> <a href=\"detailEtudiant.php?Filiere=$filiere&Code=$code\">$code</a></td>
               <td> <a href=\"detailEtudiant.php?Filiere=$filiere&Code=$code\">$prenom </a></td>
               <td> <a href=\"detailEtudiant.php?Filiere=$filiere&Code=$code\">$nom  </a></td>
               <td>$note</td>
               <td>"  . getMention($note) . "</td>
            </tr> ";
    }
    echo "<tr><td colspan='5' > <a href=\"formAjoute.php\">Ajouter un Etudiant</a> </td></tr>";
